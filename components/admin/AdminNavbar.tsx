...
export default function AdminNavbar() {
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between border-b border-white/10 bg-black/20 backdrop-blur-sm px-4 sm:px-10 py-4">
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-[var(--emerald-green)]">
          Yata
        </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <HeadlessMenu as="div" className="relative">
            <HeadlessMenu.Button
              ...
              style={{
                backgroundImage:
                  'url("https://png.pngtree.com/png-vector/20190704/ourmid/pngtree-businessman-user-avatar-free-vector-png-image_1538405.jpg")',
              }}
            ></HeadlessMenu.Button>
            ...
            >
              <HeadlessMenu.Items className="absolute right-0 mt-2 w-40 origin-top-right rounded-xl bg-[#0d1117] border border-white/10 shadow-lg ring-1 ring-black/5 focus:outline-none">
                  ...
                  <HeadlessMenu.Item>
                    {({ active }) => (
                      <button
                        ...
                        className={`${
                          active
                            ? "bg-[var(--emerald-green)]/20 text-[var(--emerald-green)]"
        ...
        <>
          ...
          >
            ...
            <div className="flex flex-col items-start gap-4 px-6 py-4 text-sm font-medium text-[var(--text-secondary)]">
              ...
              <button
                onClick={handleLogout}
                className="mt-4 flex items-center gap-2 text-[var(--emerald-green)] hover:underline"
              >
                <LogOut className="w-4 h-4" />
                Logout
              </button>
