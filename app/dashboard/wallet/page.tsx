...
import FundWalletInner from "@/components/wallet/FundWalletInner";

export default function FundWallet() {
  return (
    <Suspense fallback={<div className="p-8 text-white">Loading wallet…</div>}>
      <FundWalletInner />
    </Suspense>
  );
}
...
// let PaystackPop: any; // declare a placeholder
...
//     setHistory: React.Dispatch<React.SetStateAction<FundingHistory[]>>,
...
//         onSuccess: async (trx: PaystackTransaction) => {
...
//           handleFinish();
//         },
//         onError: (err: PaystackError) => {
//           console.error("❌ Paystack error:", err);
//           setError(err.message);
//           handleFinish();
//         },
//         onLoad: (tranx: PaystackTransaction) =>
//           console.log("💡 Transaction loaded:", tranx),
//       });
//     } else {
//       console.log(
